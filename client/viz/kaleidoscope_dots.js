...
import { sin, circle, star, drawShape, fractal } from '../util/canvases/dots'
import { defaultTheme } from '../util/color_themes'

export default class Dots extends Visualizer {
  constructor () {
  ...
  paint ({ ctx, height, width, now }) {
    ...
    fractal(ctx, 175, width/2, height/2, this.rotation)
    ctx.stroke()
  }
}