...
import { sin, circle, star, drawShape, fractal } from '../util/canvases/fractal_mirror'
import { defaultTheme } from '../util/color_themes'

export default class FractalMirror extends Visualizer {
  constructor () {
  ...
  paint ({ ctx, height, width, now }) {
    ...
    fractal(ctx, 400, width/2, height/2, this.rotation)
    ctx.stroke()
  }
}