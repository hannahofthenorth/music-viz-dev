...
import { sin, circle, star, drawShape, fractal } from '../util/canvases/canvas'
import { griffinFavorite } from '../util/color_themes'

export default class Griffin extends Visualizer {
  constructor () {
    super({ volumeSmoothing: 10 })
    this.theme = griffinFavorite
    this.counter = 1
    this.rotation = 20
    this.height = 256
    this.section = 1
